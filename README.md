...
2. **蒸锅 (Steamer)**: 底部垫热源（营火/岩浆），打开 GUI 放入稻米，将其蒸熟成为 🍚**蒸米**。(10秒)
3. **培育盘 (Koji Tray)**: 必须放置在亮度≤7的昏暗处。打开 GUI 放入蒸米和米曲霉孢子，培育成 **米曲**。(30秒)
4. **发酵桶 (Fermentation Barrel)**: 打开 GUI 放入 米曲 + 蒸米 + 水瓶，经过混合发酵后产出 **酒醪**。(60秒)
5. **压榨床 (Presser)**: 打开 GUI 放入酒醪，将其压榨成传说中的 🍶**鬼族大吟酿 (Ibuki Sake)**。(5秒)
...
2. **压榨床 (Presser)**: 打开 GUI 将葡萄压榨成 🥤**葡萄汁**。(3秒)
3. **发酵桶 (Fermentation Barrel)**: 在 GUI 中放入葡萄汁 + 水瓶直接发酵，得到 🍷**蕾米莉亚的血红葡萄酒 (Remilia's Blood Red Wine)**。(45秒)

*血红葡萄酒效果：夜视 II，力量 II，再生 II，短暂反胃。*

### 🍑 幽雅梅酒线 (Infusion Pipeline) - **[已完成 Completed]**
以基底酒浸泡青梅的配制酒路线：
1. **青梅种植 (Green Plum Farming)**: 种下青梅种子，收获可用于泡酒的 🍑**青梅**。
2. **基底酒准备 (Base Spirit)**: 先走完清酒线，获得 🍶**鬼族大吟酿** 作为当前版本的基底酒。
3. **泡酒罐 (Infusion Jar)**: 打开 GUI 放入 鬼族大吟酿 + 青梅 + 糖，密封静置后产出 **八意永琳的幽雅梅酒**。(60秒)
...
- [x] **Phase 4B: 泡酒配制工艺 (Infusion)**: 已新增青梅作物与泡酒罐，通过鬼族大吟酿作为基底酒浸泡青梅与糖，产出八意永琳的幽雅梅酒。
